...
RSpec.describe OutputDatasetWorker do
  ...
  describe "on legacy dhis2" do
    ...
    def stub_find_by_name
      stub_request(:get, "http://play.dhis2.org/demo/api/dataSets?fields=:all&filter=name:eq:ORBF%20-%20Payment%20rule%20pma%20-%20Quarterly")
        .to_return(status: 200, body: "{\"dataSets\":[{\"id\":\"uuiddataset\", \"name\":\"ORBF - Payment rule pma - Quarterly\",\"shortName\":\"ORBF - Payment rule pma - Quarterly\",\"code\":null,\"periodType\":\"Quarterly\",\"dataElements\":[],\"organisationUnits\":[],\"categoryCombo\":{\"id\":\"p0KPaWEg3cf\",\"name\":\"default\"}}]}")
    end

    def stub_update
      stub_request(:put, "http://play.dhis2.org/demo/api/dataSets/uuiddataset")
        .with(body: "{\"id\":\"uuiddataset\",\"name\":\"ORBF - Payment rule pma - Quarterly\",\"shortName\":\"ORBF - Payment rule pma - Quarterly\",\"code\":null,\"periodType\":\"Quarterly\",\"dataElements\":[{\"id\":\"ext-quality_technical_score_value\"},{\"id\":\"ext-max_points\"},{\"id\":\"ext-attributed_points\"}],\"organisationUnits\":[{\"id\":\"Bq5nb7UAEGd\"},{\"id\":\"GQcsUZf81vP\"},{\"id\":\"IXJg79fclDm\"},{\"id\":\"JCXEtUDYyp9\"},{\"id\":\"JNJIPX9DfaW\"},{\"id\":\"NnQpISrLYWZ\"},{\"id\":\"OuwX8H2CcRO\"},{\"id\":\"T2Cn45nBY0u\"},{\"id\":\"Tht0fnjagHi\"},{\"id\":\"bM4Ky73uMao\"},{\"id\":\"bqtZrXoryDF\"},{\"id\":\"cdmkMyYv04T\"},{\"id\":\"cgqkFdShPzg\"},{\"id\":\"ctN0WgIvfke\"},{\"id\":\"jCnyQOKQBFX\"},{\"id\":\"jk1TtiBM5hz\"},{\"id\":\"kLNQT4KQ9hT\"},{\"id\":\"kMTHqMgenme\"},{\"id\":\"mTNOoGXuC39\"},{\"id\":\"nCh5dBoJVNw\"},{\"id\":\"roQ2l7TX0eZ\"},{\"id\":\"taKiTcaf05H\"},{\"id\":\"uNEhNuBUr0i\"},{\"id\":\"uROAmk9ymNE\"},{\"id\":\"vRC0stJ5y9Q\"},{\"id\":\"vv1QJFONsT6\"},{\"id\":\"wNYYRm2c9EK\"},{\"id\":\"xmZNDeO0qCR\"}],\"categoryCombo\":{\"id\":\"p0KPaWEg3cf\",\"name\":\"default\"},\"displayName\":\"ORBF - Payment rule pma - Quarterly\"}")
        .to_return(status: 200, body: "")
      stub_request(:put, "http://play.dhis2.org/demo/api/dataSets/uuiddataset")
        .with(body: "{\"id\":\"uuiddataset\",\"name\":\"ORBF - Payment rule pma - Quarterly\",\"shortName\":\"ORBF - Payment rule pma - Quarterly\",\"code\":null,\"periodType\":\"Quarterly\",\"dataElements\":[{\"id\":\"ext-attributed_points\"},{\"id\":\"ext-max_points\"},{\"id\":\"ext-quality_technical_score_value\"}],\"organisationUnits\":[{\"id\":\"Bq5nb7UAEGd\"},{\"id\":\"GQcsUZf81vP\"},{\"id\":\"IXJg79fclDm\"},{\"id\":\"JCXEtUDYyp9\"},{\"id\":\"JNJIPX9DfaW\"},{\"id\":\"NnQpISrLYWZ\"},{\"id\":\"OuwX8H2CcRO\"},{\"id\":\"T2Cn45nBY0u\"},{\"id\":\"Tht0fnjagHi\"},{\"id\":\"bM4Ky73uMao\"},{\"id\":\"bqtZrXoryDF\"},{\"id\":\"cdmkMyYv04T\"},{\"id\":\"cgqkFdShPzg\"},{\"id\":\"ctN0WgIvfke\"},{\"id\":\"jCnyQOKQBFX\"},{\"id\":\"jk1TtiBM5hz\"},{\"id\":\"kLNQT4KQ9hT\"},{\"id\":\"kMTHqMgenme\"},{\"id\":\"mTNOoGXuC39\"},{\"id\":\"nCh5dBoJVNw\"},{\"id\":\"roQ2l7TX0eZ\"},{\"id\":\"taKiTcaf05H\"},{\"id\":\"uNEhNuBUr0i\"},{\"id\":\"uROAmk9ymNE\"},{\"id\":\"vRC0stJ5y9Q\"},{\"id\":\"vv1QJFONsT6\"},{\"id\":\"wNYYRm2c9EK\"},{\"id\":\"xmZNDeO0qCR\"}],\"categoryCombo\":{\"id\":\"p0KPaWEg3cf\",\"name\":\"default\"},\"displayName\":\"ORBF - Payment rule pma - Quarterly\"}")
        .to_return(status: 200, body: "", headers: {})
    end
  end
end

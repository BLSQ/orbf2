  ...
  def index
    @steps = calculate_highlighted [
      ...
      Step.new(name:   "Entities",
               status:  current_user.invalid_project? || current_user.project.entity_group.nil? ? :todo : :done,
               kind:   :entities,
      ...
      Step.new(name:   "Package of Activities",
               status: current_user.invalid_project? || current_user.project.entity_group || current_user.project.packages.ni? ? :todo : :done,
               kind:   :packages,
